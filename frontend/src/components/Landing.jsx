...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-black text-white font-sans">
      {/* Navbar */}
      <nav className="w-full max-w-7xl mx-auto flex justify-between items-center py-6 px-6 animate-fade-in fixed top-0 left-0 right-0 z-50 bg-black/30 backdrop-filter backdrop-blur-lg border-b border-white/10">
      ...
      <section
        id="home"
        className="w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-14 mt-24 px-6 animate-slide-in min-h-[calc(100vh-80px)]"
      >
